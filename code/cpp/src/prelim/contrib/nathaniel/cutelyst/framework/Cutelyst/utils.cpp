...
{
 QString arf = QString::fromLatin1(APPS_ROOT_FOLDER);
 QString irf = QString::fromLatin1(INSTALL_ROOT_FOLDER);
 QString frf = QString::fromLatin1(FRAMEWORK_ROOT_FOLDER);
 QString rf = QString::fromLatin1(ROOT_FOLDER);

 QString qf = QString::fromLatin1(QT_LIBS_FOLDER);
