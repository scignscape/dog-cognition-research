...
#ifndef QH_CPP_GRAPH__H
#define QH_CPP_GRAPH__H
...
class Qh_CPP_Graph : public phaong<pg_t>
{
 Qh_CPP_Node* root_node_;
...
public:
 ...
 Qh_CPP_Graph(Qh_CPP_Node* root_node = nullptr);
