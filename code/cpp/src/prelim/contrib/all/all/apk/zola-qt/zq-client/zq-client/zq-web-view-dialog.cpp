...
void ZQ_Web_View_Dialog::reset_tab_selection()
{
...
void ZQ_Web_View_Dialog::add_url_pattern(QUrl url)
{
...
//? pm_runtime_ = new Pattern_Matcher_Runtime;
 ...
 wev_ = new ZQ_Web_Engine_View(this);
 //wev->setGeometry(0,0,700,600);

//?
 wep_ = new ZQ_Web_Engine_Page(wev_);

 QObject::connect(wep_, &ZQ_Web_Engine_Page::urlChanged,[this](const QUrl& url)
 {
  QString path = url.path();
...
//  qDebug() << "r:" << url.toString();
 ...
 QObject::connect(wep_, &ZQ_Web_Engine_Page::navRequest,[this](const QUrl &url, QPoint pos)
 {
  qDebug() << "pos:" << pos;
 ...
 QObject::connect(wep_, &ZQ_Web_Engine_Page::linkHovered,[](const QUrl &url){
...
// connect(wev_, &ZQ_Web_Engine_View::youtube_download_requested,
//   this, &ZQ_Web_View_Dialog::youtube_download_requested);
...
void ZQ_Web_View_Dialog::resizeEvent(QResizeEvent* resize_event)
{
 Q_EMIT web_view_geometry_updated(get_web_view_geometry());
}

void ZQ_Web_View_Dialog::moveEvent(QMoveEvent* move_event)
{
 if(this->isVisible())
   Q_EMIT web_view_geometry_updated(get_web_view_geometry());
}
...
QRect ZQ_Web_View_Dialog::get_web_view_geometry()
{
...
void ZQ_Web_View_Dialog::mouseReleaseEvent(QMouseEvent* mev)
{
 qDebug() << " mr: " << mev->pos();
...
void ZQ_Web_View_Dialog::mousePressEvent(QMouseEvent* mev)
{
 qDebug() << " mp: " << mev->pos();
...
ZQ_Web_View_Dialog::~ZQ_Web_View_Dialog()
{
...
//void ZQ_Web_View_Dialog::set_context_menu_provider(Context_Menu_Provider *context_menu_provider)
//{
...
//void ZQ_Web_View_Dialog::add_fixed_url_pattern(QString context, QString sec, QString pattern,
...
//void ZQ_Web_View_Dialog::handle_add_url_patterns_row()
//{
...
//void ZQ_Web_View_Dialog::handle_edit_url_patterns_row(int rc)
//{
// qDebug() << "rc = " << rc;
...
//void ZQ_Web_View_Dialog::handle_cancel_remove_url_patterns_row(int rc)
//{
...
//void ZQ_Web_View_Dialog::handle_save_url_patterns_row(int rc)
//{
// for(int i = 0; i < 5; ++i)
// {
//  QTableWidgetItem* twi = url_patterns_table_->item(rc, i);
