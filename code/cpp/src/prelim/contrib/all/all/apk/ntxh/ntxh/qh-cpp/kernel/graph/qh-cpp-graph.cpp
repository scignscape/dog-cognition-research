...
Qh_CPP_Graph::Qh_CPP_Graph(Qh_CPP_Node* root_node)
...
void Qh_CPP_Graph::add_structure_type(QString name, unsigned int l,
  signed int offset)
{
 types_[name] = {l, {offset, -1}};
}

void Qh_CPP_Graph::add_array_type(QString name, unsigned int l,
...
void Qh_CPP_Graph::add_fixed_array_type(QString name, unsigned int l,
  signed int offset)
{
 types_[name] = {l, {offset, -1}};
}

void Qh_CPP_Graph::update_current_field_index(QString type_name,
...
void Qh_CPP_Graph::add_read_token(hypernode_type* hn, QString type_name,
...
void Qh_CPP_Graph::array_append(hypernode_type* hn, hypernode_type* nhn)
{
...
void Qh_CPP_Graph::add_type_field_index(QString type_name, QString field_name, int code)
{
 field_indices_.insert({type_name, field_name}, code);
}

Qh_CPP_Graph::hypernode_type* Qh_CPP_Graph::new_hypernode_by_type_name(QString ty)
{
