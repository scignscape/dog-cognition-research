...
#ifndef SES_CONFIGURATION_DIALOG__H
#define SES_CONFIGURATION_DIALOG__H
...
class SES_Configuration_Dialog : public QDialog
{
...
public:
 ...
 SES_Configuration_Dialog(QWidget* parent = nullptr);

 ~SES_Configuration_Dialog();
...
#endif  // SES_CONFIGURATION_DIALOG__H
