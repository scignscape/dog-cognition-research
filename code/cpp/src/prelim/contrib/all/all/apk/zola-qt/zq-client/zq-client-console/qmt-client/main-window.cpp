...
{
 setWindowTitle("ZoLa Native Client");
...
{
 lanternfly_frame_->set_view_zoom_level(zoom_level);
 lanternfly_frame_->center_on(longitude, latitude);

 lanternfly_frame_->check_run_coords_notify_callback(longitude, latitude);
