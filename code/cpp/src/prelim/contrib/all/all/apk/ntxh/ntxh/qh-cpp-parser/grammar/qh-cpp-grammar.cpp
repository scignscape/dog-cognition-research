...
#include "qh-cpp-grammar.h"

#include "qh-cpp-parse-context.h"

#include "qh-cpp-graph-build.h"

#include "qh-cpp-parser.h"
...
Qh_CPP_Grammar::Qh_CPP_Grammar()
{
}

void Qh_CPP_Grammar::init(Qh_CPP_Parser& p, Qh_CPP_Graph& g, Qh_CPP_Graph_Build& graph_build)
{
...
//   {sample_context, group_context});
 ...
 Qh_CPP_Parse_Context& parse_context = graph_build.parse_context();
